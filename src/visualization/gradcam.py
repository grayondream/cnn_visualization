...
from utils.misc import get_example_params, save_class_activation_images, preprocess_image
from PIL import Image
import os
...
class CamExtractor():
    ...
    def forward_pass_on_convolutions(self, x):
        ...
        """
        conv_output = None
        for module_pos, module in enumerate(self.features):
            if str(module)[:6] == 'Linear':
                '''
                此处是模型相关的
                '''
