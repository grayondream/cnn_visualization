...
from core.basic_model import basic_model, conv1x1, conv3x3
...
def _resnet(arch, block, layers, pretrained,replace_stride_with_dilation=None, **kwargs):
...
def resnet50_dilated(pretrained=None,  **kwargs):
    r"""ResNet-50 model from
    `"Deep Residual Learning for Image Recognition" <https://arxiv.org/pdf/1512.03385.pdf>`_
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet('resnet50', Bottleneck, [3, 4, 6, 3], pretrained, replace_stride_with_dilation=[1, 2, 2],**kwargs)
...
def resnext50_32x4d(pretrained=None,  **kwargs):
...
def resnext101_32x8d(pretrained=None,  **kwargs):
...
def wide_resnet50_2(pretrained=None,  **kwargs):
...
def wide_resnet101_2(pretrained=None,  **kwargs):
...
if __name__ == '__main__':
    ...
    checkpoint_finetune = torch.load(pt)
